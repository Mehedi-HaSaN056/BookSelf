...
<div class="auth-card">
  ...
  <?php if($errors->any()): ?>
    <div class="alert-danger"><i class="fas fa-exclamation-circle"></i> <?php echo e($errors->first()); ?></div>
  <?php endif; ?>
  ...
  <form method="POST" action="<?php echo e(route('login')); ?>">
    ...
    <div class="form-group <?php echo e($errors->has('email') ? 'has-error':''); ?>">
      <label>ইমেইল</label>
      <input type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="your@email.com" required autofocus>
    </div>
  ...
  <div class="auth-footer">
    অ্যাকাউন্ট নেই? <a href="<?php echo e(route('register')); ?>">রেজিস্ট্রেশন করুন</a>
  </div>
</div>
</body>
</html><?php /**PATH C:\xampp\htdocs\bookshelf\resources\views/auth/login.blade.php ENDPATH**/ ?>